...
File myFile;
const int buttonPinVBS = 9;          // input pin for pushbutton
const int buttonPinNOT = 10;          // input pin for pushbutton
int previousButtonStateNOT = HIGH;   // for checking the state of a pushButton
int previousButtonStateVBS = HIGH;   // for checking the state of a pushButton
int counterVBS= 0;                  // button push counter
int counterNOT = 0;                  // button push counter
